...
function createRows(){
	...
	for(var i=1;i<=rowNum;i++){
		tmp+="<tr height='60' ><td width='50' align='center'>"+i+"</td><td width='300' align='center'><input type='text' class='createCardTA' name='word[]' id='word"+i+"' maxlength='50' onchange='removeExtraWhitespace(this);'></td>"
		+"<td width='500' align='center'><input type='text' class='createCardTA' name='translation[]' id='translation"+i+"'  maxlength='50' onchange='removeExtraWhitespace(this);'></td></tr>";
